...
Definimos o índice de eficiência como a razão entre o resultado relativo (quanto menor a taxa, melhor) e o custo relativo (quanto maior o gasto, pior):

\begin{equation}
\text{Eficiência}_i = \frac{\text{Taxa média} / \text{Taxa}_i}{\text{Gasto}_i / \text{Gasto médio}}
\end{equation}

Valores acima de 1 indicam que o estado consegue resultados melhores que a média com custos menores que a média. A média nacional de gasto per capita é R\$ 633 e a taxa média de mortes é 81,7 por 100 mil habitantes.
...
Primeiro, a eficiência no uso de recursos de segurança varia significativamente entre os estados brasileiros. Estados como São Paulo (índice 2,82) são quase sete vezes mais eficientes que Tocantins (índice 0,43) no uso de recursos de segurança. São Paulo gasta apenas R\$ 334/capita e tem a menor taxa (54,8/100k), enquanto Tocantins gasta R\$ 1.200/capita e tem taxa de 100,3/100k.
...
Terceiro, gasto não garante resultado. Estados do Norte (TO, AP, RO, RR, AC) gastam muito mais que a média nacional (R\$ 633/capita), mas mantêm taxas de violência acima de 60/100k. A qualidade da gestão é determinante.
